"""This is a template for State Machine Modules
   ...
   In addition, it listens to path information from the Simplistic Path detector,
   and actuates accordingly.
"""
...
def loop():
    ...
    - Car.send(x,y,u,v) to communicate two integers (x and y) and
      ...
      are ignored while u encodes the speed and v the relative angle to turn to.
    '''
    global state
    event = Event.poll()
